...
public class mediumcomp extends JFrame {
	...
	public mediumcomp() {
		...
		txtrWelcomeToThe.setBounds(412, 40, 979, 545);
...
//....
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							code_page frame = new code_page("Java","Hard","Java1","Jtest13.txt","Jtest23.txt","output.txt","Jout13.txt");
...
//			}
		...
		btnNewButton.setBounds(1004, 608, 89, 23);
