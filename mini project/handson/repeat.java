...
public class repeat extends JFrame {
	...
	public repeat(String sel) {
		...
		txtrYouDidntPassed.setForeground(new Color(255, 255, 255));
		txtrYouDidntPassed.setOpaque(false);
		txtrYouDidntPassed.setFont(new Font("Monospaced", Font.BOLD, 25));
		...
		txtrYouDidntPassed.setBounds(-64, 228, 1199, 122);
		...
		btnNewButton.setBounds(175, 527, 137, 33);
		...
		btnNewButton_1.setBounds(774, 527, 106, 33);
		contentPane.add(btnNewButton_1);
		Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
	    setBounds(0,0,screenSize.width, screenSize.height);
	    setExtendedState(JFrame.MAXIMIZED_BOTH);
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\monisha.m\\Downloads\\Untitled design (33).png"));
