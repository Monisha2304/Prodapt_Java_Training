		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							code_page frame = new code_page("Python","Hard","Python","Jtest13.txt","Jtest23.txt","output.txt","Jout13.txt");
...
//			}
		...
		btnNewButton.setBounds(913, 622, 89, 23);
