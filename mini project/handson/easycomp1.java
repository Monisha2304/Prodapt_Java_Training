...
public class easycomp1 extends JFrame {
	...
	public easycomp1() {
		...
		txtrWelcomeToThe.setBounds(419, 11, 914, 535);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							code_page frame = new code_page("Python","Medium","Python","Jtest12.txt","Jtest22.txt","output.txt","Jout12.txt");
...
//			}
		...
		btnNewButton.setBounds(1050, 569, 89, 23);
