...
public class javaeasy extends JFrame {
	...
	public javaeasy() {
		...
		txtrYouAreAt.setBounds(431, 24, 797, 453);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							code_page frame = new code_page("Java","Easy","Java1","Jtest1.txt","Jtest2.txt","output.txt","Jout1.txt");
...
//			}
		...
		btnNewButton.setBounds(993, 529, 89, 23);
