...
public class pythoneasy extends JFrame {
	...
	public pythoneasy() {
		...
		txtrYouAreAt.setForeground(new Color(0, 0, 0));
		...
		btnNewButton.setBounds(806, 516, 89, 23);
